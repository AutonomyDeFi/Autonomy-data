...
# from langchain.libs.experimental.langchain_experimental.autonomous_agents.autogpt.agent import AutoGPT
# /Users/marissaposner/Autonomy-data/autonomy/langchain/libs/experimental/langchain_experimental/autonomous_agents/autogpt/agent.py
...
from autonomy.tool.defillama.aave import AaveV3
from autonomy.tool.defillama.defillama import DefiLlama
from autonomy.tool.defillama.lido import Lido
from autonomy.tool.defillama.rocketpool import RocketPool 
from autonomy.tool.inch import InchPrices, Inch, InchPrices

from openai_helper import return_file_as_str
load_dotenv()
...
OBJECTIVE = "You are an AGI agent responsible for providing recommendations on which agent should be used to handle a specific task. Analyze the provided major objective of the project and a single task from the JSON checklist generated by the previous agent, and suggest the most appropriate agent to work on the task. Your task is: Find the best token to buy and buy 100 tokens."
...
def task_creation_agent(objective: str, result: Dict, task_description: str, task_list: List[str]):
    whole_file = return_file_as_str('/Users/marissaposner/Autonomy-data/tool2info.json')
